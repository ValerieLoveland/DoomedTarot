/*
			...
			Assignment: 3
			File: Upright Card
			Description: This class is for Upright card because it will display in a different way from reversed
			eventually and also so I can implement only reversed or only upright for a plot point later
